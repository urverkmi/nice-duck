/*
 * Charging bolt icon used by draw_battery(). Generated bitmap (I2 format).
 * From the stock zmk nice_view widget (MIT, The ZMK Contributors).
 *
 * This is a good reference for what a hand-converted LVGL image looks like —
 * see assets/README.md to make your own.
 *
...
#if CONFIG_NICE_DUCK_WIDGET_INVERTED
